...
public:
    ...
    inline bool operator==(const RSTNode& other) { return data == other.data; }

    inline bool operator==(RSTNode&& other) { return data == other.data; }
...
public:
    ...
    {
        if (n >= RST::M)
            throw std::runtime_error("Map node child array size exceeded");
        children[n++] = node;
    }
