...
namespace sxi
{
	...
	void Renderer::createDepthResources()
	{
		...
		createImage(swapChainExtent.width, swapChainExtent.height, depthFormat, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, depthImage, depthImageMem);
	...
	void Renderer::createImage(u32 width, u32 height, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& imageMem)
	{
	...
	void Renderer::createTextureImage()
	{
		...
		createBuffer(image->getSize(), VK_BUFFER_USAGE_TRANSFER_SRC_BIT, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, stagingBuffer, stagingBufferMem);

		void* data;
		vkMapMemory(logicalDevice, stagingBufferMem, 0, image->getSize(), 0, &data);
		memcpy(data, image->raw(), SXI_TO_SIZE(image->getSize()));
		...
		copyBufferToImage(stagingBuffer, textureImage, SXI_TO_U32(image->getWidth()), SXI_TO_U32(image->getHeight()));
